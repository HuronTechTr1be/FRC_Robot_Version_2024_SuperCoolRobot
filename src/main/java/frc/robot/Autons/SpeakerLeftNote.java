...
public class SpeakerLeftNote extends SequentialCommandGroup     {
    
  private RobotContainer m_robotContainer;

    public SpeakerLeftNote(DriveSubsystem drive, EgressSubsystem shoot, IntakeModule conveyorBelt, SweeperWheelsSubsystem sweepers, FlapSubsystem flap){
        addCommands(
            new HighShootTimed(shoot, conveyorBelt, sweepers,flap, 0.3),
            new WaitCommand(0.5),

            new DriveTimed(drive, 0, 0, 0.4, 0.15),

...
public class BLUESpeakerRightNote extends SequentialCommandGroup {
  ...
  public BLUESpeakerRightNote(DriveSubsystem drive, EgressSubsystem shoot, IntakeModule conveyorBelt,
    ...
    super(
        ...
        new RunCommand(() -> drive.drive(-0.5, 0, 0, false, true), drive).until(() -> drive.checkEncoder(1.15)),
        new WaitCommand(0.3),

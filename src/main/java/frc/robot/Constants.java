...
public final class Constants {
  ...
  public static final class EgressConstants {
    ...
    public static final double id43LowShootFactor = .25; // top low shooter power level
    public static final double id44LowShootFactor = .25; // top low shooter power level

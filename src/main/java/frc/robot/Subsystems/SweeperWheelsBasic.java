...
public class SweeperWheelsBasic {
    ...
    public void PickUp() {
        ...
        if (sweeperWheel.getDeviceId() == 31) {
            double sweeperWheel31PickupFactor = SmartDashboard.getNumber("Sweeper Wheel 31 Pickup Factor",
                    SweeperWheelConstants.id31PickUpFactor);
            ...
            double sweeperWheel32PickupFactor = SmartDashboard.getNumber("Sweeper Wheel 32 Pickup Factor",
                    SweeperWheelConstants.id32PickUpFactor);
    ...
    public void Reject() {
        ...
        if (sweeperWheel.getDeviceId() == 31) {
            double sweeperWheel31RejectFactor = SmartDashboard.getNumber("Sweeper Wheel 31 Reject Factor",
                    SweeperWheelConstants.id31RejectFactor);
            ...
            double sweeperWheel32RejectFactor = SmartDashboard.getNumber("Sweeper Wheel 32 Reject Factor",
                    SweeperWheelConstants.id32RejectFactor);
